...
const PrivacyPolicy = () => {
  return (
    <div className="mx-auto min-h-screen w-full max-w-4xl px-5 py-9 ">
      <h1 className="text-foreground text-center text-3xl font-semibold md:text-4xl">
        Privacy Policy
      </h1>
      <Paragraph>
        At RefineMyContent, accessible from refinemycontent.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        RefineMyContent and how we use it.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        shared and/or collect in RefineMyContent. This policy is not applicable
      ...
      <ul className="text-muted-foreground list-inside list-disc space-y-3 text-lg">
      ...
      <Paragraph>
        RefineMyContent follows a standard procedure of using log files. These
      ...
      <Paragraph>
        Like any other website, RefineMyContent uses "cookies". These cookies
      ...
      <SubHeading>Google DoubleClick DART Cookie</SubHeading>
      <Paragraph>
      ...
      <SubHeading>Our Advertising Partners</SubHeading>
      <Paragraph>
      ...
      <Paragraph>
        ...
        advertising partners of RefineMyContent. Third-party ad servers or ad
        ...
        RefineMyContent, which are sent directly to users' browser. They
        ...
        websites that you visit. Note that RefineMyContent has no access to or
        control over these cookies that are used by third-party advertisers.
      </Paragraph>
      <SubHeading>Advertising Partners Privacy Policies</SubHeading>
      <Paragraph>
        You may consult this list to find the Privacy Policy for each of the
        advertising partners of RefineMyContent.
      </Paragraph>
      <Paragraph>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on RefineMyContent, which are sent
      ...
      <Paragraph>
        Note that RefineMyContent has no access to or control over these cookies
        that are used by third-party advertisers.
      </Paragraph>
      <SubHeading>Third Party Privacy Policies</SubHeading>
      <Paragraph>
        RefineMyContent's Privacy Policy does not apply to other advertisers or
      ...
      <SubHeading>GDPR Data Protection Rights</SubHeading>
      <Paragraph>
      ...
      <SubHeading>Children's Information</SubHeading>
      <Paragraph>
      ...
      <Paragraph>
        RefineMyContent does not knowingly collect any Personal Identifiable

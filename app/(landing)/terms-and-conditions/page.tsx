...
const Paragraph = ({ children }: PropsWithChildren) => {
  return (
    <p className="text-muted-foreground my-4 text-lg leading-8">{children}</p>
  );
};

const SubHeading = ({ children }: PropsWithChildren) => {
  return (
    <h2 className="text-foreground mt-7 text-xl font-semibold md:text-2xl">
      {children}
    </h2>
  );
};
const TermsAndConditions = () => {
  return (
    <div className="mx-auto min-h-screen w-full max-w-4xl px-5 py-9 ">
      <h1 className="text-foreground mt-5 text-center text-3xl font-semibold md:text-4xl">
        Terms And Conditions
      </h1>
      <Paragraph>Welcome to RefineMyContent!</Paragraph>
      <Paragraph>
        These terms and conditions outline the rules and regulations for the use
        of refinemycontent's Website, located at refinemycontent.dev.
      </Paragraph>
      <Paragraph>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use refinemycontent if you do not agree
      ...
      <Paragraph>
        ...
        subject to, prevailing law of et. Any use of the above terminology or
      ...
      <Paragraph>
        We employ the use of cookies. By accessing refinemycontent, you agreed
        to use cookies in agreement with the refinemycontent's Privacy Policy.
      </Paragraph>
      ...
      <Paragraph>
        Unless otherwise stated, refinemycontent and/or its licensors own the
        intellectual property rights for all material on refinemycontent. All
        intellectual property rights are reserved. You may access this from
        refinemycontent for your own personal use subjected to restrictions set
        in these terms and conditions. You must not:
      </Paragraph>

      <ul className="text-muted-foreground mt-5 list-inside list-disc space-y-3 text-lg">
      ...
      <Paragraph>This Agreement shall begin on the date here.</Paragraph>

      <Paragraph>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        refinemycontent does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of refinemycontent,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, refinemycontent
      ...
      <Paragraph>
        refinemycontent reserves the right to monitor all Comments and to remove
      ...
      <Paragraph>
        You hereby grant refinemycontent a non-exclusive license to use,
      ...
      <Paragraph>
        ...
        the hyperlink compensates the absence of refinemycontent; and (d) the
      ...
      <Paragraph>
        ...
        e-mail to refinemycontent. Please include your name, your organization
      ...
      <SubHeading>
        No use of refinemycontent's logo or other artwork will be allowed for
        linking absent a trademark license agreement.
      </SubHeading>

      <SubHeading>iFrames</SubHeading>
      ...
      <SubHeading>Content Liability</SubHeading>
